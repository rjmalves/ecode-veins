...
Coord& ADVMessage::getSenderPos()
{
    return this->senderPos;
}

void ADVMessage::setSenderPos(const Coord& senderPos)
{
    this->senderPos = senderPos;
}

Coord& ADVMessage::getSenderDirection()
{
    return this->senderDirection;
}

void ADVMessage::setSenderDirection(const Coord& senderDirection)
{
...
int ADVMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "senderDirection")==0) return base+3;
    if (fieldName[0]=='s' && strcmp(fieldName, "senderDestination")==0) return base+4;
    if (fieldName[0]=='s' && strcmp(fieldName, "simTime")==0) return base+5;
...
void *ADVMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return (void *)(&pp->getSenderDirection()); break;
        default: return nullptr;
    }
}
